...
loginFormElement.addEventListener('submit', function(event) {
  ...
  */
  ...
  /* Comment : Memastikan bahwa nilai email dan pw sesuai dengan nilai yang tersimpan. */
  if (email == expectedEmail && password == expectedPassword) {
    ...
    /* Comment : Namun jika tidak sesuai makan akan ditampilkan informasi bahwa input salah. */
    showPopUp();
  }
});
